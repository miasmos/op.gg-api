...
module.exports = class opgg {
    constructor(opts) {
        ...
        if (!!this.api_key && !validate.RiotAPIKey(this.api_key))
    ...
    Live(region, callback) {
        ...
        if (typeof callback === "function") {
            if (!validated) {
                callback(
                    new Error(errorMessages.INVALID_PARAM_REGION, responseCodes.BAD_REQUEST),
                    undefined
                );
            } else {
                parse
                    .Live(region, this.api_key)
                    .then(json => {
    ...
    Renew(region, summonerId, callback) {
        ...
        if (typeof callback === "function") {
            if (!validated.region) {
                ...
                callback(
                    new Error(errorMessages.INVALID_PARAM_SUMMONER_ID, responseCodes.BAD_REQUEST),
                    undefined
                );
            } else {
                parse
                    .Renew(region, summonerId, this.api_key)
                    .then(json => {
                        callback(undefined, json);
                    })
                    .catch(error => {
            ...
            return new Promise((resolve, reject) => {
                if (!validated.region)
                    ...
                    reject(
                        new Error(
                            errorMessages.INVALID_PARAM_SUMMONER_ID,
    ...
    SummonerStats(region, summoner) {
        return new Promise((resolve, reject) => {
            ...
            if (!validated.region)
                reject(new Error(errorMessages.INVALID_PARAM_REGION, responseCodes.BAD_REQUEST));
            else if (!validated.summoner)
                reject(
                    new Error(errorMessages.INVALID_PARAM_SUMMONER_NAME, responseCodes.BAD_REQUEST)
                );
            else
                fetch(`http://localhost:${this.opggApiServerPort}/${region}/stats/${summoner}`)
                    .then(res => res.json())
    ...
    Summary(region, summoner, callback) {
        ...
        if (typeof callback === "function") {
            if (!validated.region) {
                ...
                parse
                    .summaryCombined(region, summoner, this.api_key)
                    .then(json => {
                        callback(undefined, json);
                    })
                    .catch(error => {
            ...
            return new Promise((resolve, reject) => {
                if (!validated.region)
                    ...
                    reject(
                        new Error(
                            errorMessages.INVALID_PARAM_SUMMONER_NAME,
                            responseCodes.BAD_REQUEST
                        )
                    );
    ...
    SummaryRanked(region, summoner, callback) {
        ...
        if (typeof callback === "function") {
            if (!validated.region) {
                ...
                parse
                    .SummaryRanked(region, summoner, this.api_key)
                    .then(json => {
                        callback(undefined, json);
                    })
                    .catch(error => {
    ...
    SummaryNormal(region, summoner, callback) {
        ...
        if (typeof callback === "function") {
            if (!validated.region) {
                ...
                parse
                    .SummaryNormal(region, summoner, this.api_key)
                    .then(json => {
                        callback(undefined, json);
                    })
                    .catch(error => {
    ...
    Champions(region, summoner, season, callback) {
        ...
        if (typeof callback === "function") {
            if (!validated.region) {
                ...
                parse
                    .Champions(region, summoner, season, this.api_key)
                    .then(json => {
                        callback(undefined, json);
                    })
                    .catch(error => {
            ...
            return new Promise((resolve, reject) => {
                ...
                else if (!validated.season)
                    reject(
                        new Error(errorMessages.INVALID_PARAM_SEASON, responseCodes.BAD_REQUEST)
                    );
    ...
    League(region, summoner, callback) {
        ...
        if (typeof callback === "function") {
            if (!validated.region) {
                ...
                parse
                    .League(region, summoner, this.api_key)
                    .then(json => {
                        callback(undefined, json);
                    })
                    .catch(error => {
    ...
    Runes(region, summoner, callback) {
        ...
        if (typeof callback === "function") {
            if (!validated.region) {
                ...
                parse
                    .Runes(region, summoner, this.api_key)
                    .then(json => {
                        callback(undefined, json);
                    })
                    .catch(error => {
    ...
    Masteries(region, summoner, callback) {
        ...
        if (typeof callback === "function") {
            if (!validated.region) {
                ...
                parse
                    .Masteries(region, summoner, this.api_key)
                    .then(json => {
                        callback(undefined, json);
                    })
                    .catch(error => {
    ...
    Matches(region, summoner, start, callback) {
        ...
        if (typeof callback === "function") {
            if (!validated.region) {
                ...
                callback(
                    new Error(errorMessages.INVALID_PARAM_TIMESTAMP, responseCodes.BAD_REQUEST),
                    undefined
                );
            } else {
                if (!!start) {
                    parse
                        .Matches(region, summoner, this.api_key)
                        .then(json => {
                            callback(undefined, json);
                        })
                        .catch(error => {
                    ...
                    parse
                        .MatchesByTimestamp(region, summoner, start, this.api_key)
                        .then(json => {
                            callback(undefined, json);
                        })
                        .catch(error => {
    ...
    Match(region, gameId, summoner, callback) {
        ...
        if (typeof callback === "function") {
            if (!validated.region) {
                ...
                callback(
                    new Error(errorMessages.INVALID_PARAM_GAME_ID, responseCodes.BAD_REQUEST),
                    undefined
                );
            } else {
                parse
                    .Match(region, summoner, gameId, this.api_key)
                    .then(json => {
                        callback(undefined, json);
                    })
                    .catch(error => {
    ...
    Stats(region, type, league, period, mapId, queue, callback) {
        ...
        if (typeof callback === "function") {
            if (!validated.region) {
                ...
                callback(
                    new Error(
                        errorMessages.INVALID_PARAM_STATS_GRAPH_TYPE,
                        responseCodes.BAD_REQUEST
                    ),
                    undefined
                );
                ...
                callback(
                    new Error(errorMessages.INVALID_PARAM_STATS_LEAGUE, responseCodes.BAD_REQUEST),
                    undefined
                );
            } else if (!validated.period) {
                callback(
                    new Error(errorMessages.INVALID_PARAM_STATS_PERIOD, responseCodes.BAD_REQUEST),
                    undefined
                );
            } else if (!validated.mapId) {
                callback(
                    new Error(errorMessages.INVALID_PARAM_STATS_MAP, responseCodes.BAD_REQUEST),
                    undefined
                );
            } else if (!validated.queue) {
                callback(
                    new Error(errorMessages.INVALID_PARAM_STATS_QUEUE, responseCodes.BAD_REQUEST),
                    undefined
                );
            } else {
                parse
                    .Stats(region, type, league, period, mapId, queue, this.api_key)
                    .then(json => {
                        callback(undefined, json);
                    })
                    .catch(error => {
            ...
            return new Promise((resolve, reject) => {
                if (!validated.region)
                    ...
                    reject(
                        new Error(
                            errorMessages.INVALID_PARAM_STATS_LEAGUE,
                            responseCodes.BAD_REQUEST
                        )
                    );
                else if (!validated.period)
                    reject(
                        new Error(
                            errorMessages.INVALID_PARAM_STATS_PERIOD,
                            responseCodes.BAD_REQUEST
                        )
                    );
                else if (!validated.mapId)
                    ...
                    reject(
                        new Error(
                            errorMessages.INVALID_PARAM_STATS_QUEUE,
                            responseCodes.BAD_REQUEST
                        )
                    );
    ...
    AnalyticsByChampion(region, champion, role, callback) {
        ...
        if (typeof callback === "function") {
            if (!validated.region) {
                ...
                callback(
                    new Error(errorMessages.INVALID_PARAM_CHAMPION_NAME, responseCodes.BAD_REQUEST),
                    undefined
                );
            } else if (!validated.role) {
                callback(
                    new Error(errorMessages.INVALID_PARAM_ROLE, responseCodes.BAD_REQUEST),
                    undefined
                );
            } else {
                parse
                    .AnalyticsByChampion(region, champion, role, this.api_key)
                    .then(json => {
                        callback(undefined, json);
                    })
                    .catch(error => {
            ...
            return new Promise((resolve, reject) => {
                if (!validated.region)
                    ...
                    reject(
                        new Error(errorMessages.INVALID_CHAMPION_NAME, responseCodes.BAD_REQUEST)
                    );
                else if (!validated.role)
                    reject(new Error(errorMessages.INVALID_PARAM_ROLE, responseCodes.BAD_REQUEST));
    ...
    AnalyticsByChampionItems(region, champion, role, callback) {
        ...
        if (typeof callback === "function") {
            if (!validated.region) {
                ...
                parse
                    .AnalyticsByChampionItems(region, champion, role, this.api_key)
                    .then(json => {
                        callback(undefined, json);
                    })
                    .catch(error => {
    ...
    AnalyticsByChampionSkills(region, champion, role, callback) {
        ...
        if (typeof callback === "function") {
            if (!validated.region) {
                ...
                parse
                    .AnalyticsByChampionSkills(region, champion, role, this.api_key)
                    .then(json => {
                        callback(undefined, json);
                    })
                    .catch(error => {
    ...
    AnalyticsByChampionRunes(region, champion, role, callback) {
        ...
        if (typeof callback === "function") {
            if (!validated.region) {
                ...
                parse
                    .AnalyticsByChampionRunes(region, champion, role, this.api_key)
                    .then(json => {
                        callback(undefined, json);
                    })
                    .catch(error => {
    ...
    AnalyticsByChampionMasteries(region, champion, role, callback) {
        ...
        if (typeof callback === "function") {
            if (!validated.region) {
                ...
                parse
                    .AnalyticsByChampionMasteries(region, champion, role, this.api_key)
                    .then(json => {
                        callback(undefined, json);
                    })
                    .catch(error => {
