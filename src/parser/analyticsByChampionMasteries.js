...
class AnalyticsByChampionMasteries extends Endpoint {
    path() {
    ...
    parse($) {
        ...
        data.masteries = [];
        //parse masteries
        $(".ChampionStatsDetailTable .Content")
            .eq(0)
            .find(".Row")
            .each((i, element) => {
...
export default AnalyticsByChampionMasteries;
