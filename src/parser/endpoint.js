...
class Endpoint {
    ...
    parse($) {
        return new Promise((resolve, reject) => {
            reject(new Error("Parse function not implemented on this instance of Endpoint"));
        });
    }
                ...
                .then(html => {
                    ...
                    if (response instanceof Error) {
                        ...
                        if (
                            ...
                            (!Array.isArray(response) && !Object.keys(response).length)
                        ) {
    ...
    uri(params) {
        ...
        var uri =
                this.baseURI.replace("region", params.region === "kr" ? "www" : params.region) +
                path,
            didHaveParams = false,
            i = 0;
        ...
        for (var key in this.Params()) {
            ...
            if (
                key !== "region" &&
                (!(key in params) || (key in params && typeof params[key] === "undefined"))
            ) {
                if (i == 0) uri += "?";
        ...
        for (var key in params) {
            ...
            if (ignore.indexOf(key) == -1) {
                ...
                if (key !== "region" && typeof value !== "undefined")
                    uri += key + "=" + encodeURIComponent(value) + "&";
                i++;
            }
        }
